...
def sort_words(vertex_source, edge_source, window=2, pagerank_config={'alpha': 0.85, }):
    ...
    score_max = max([v for k, v in sorted_scores])
    score_min = min([v for k, v in sorted_scores])
    for index, score in sorted_scores:
        score = (score - score_min / 10) / (score_max - score_min / 10)
